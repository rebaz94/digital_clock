...
///
/// To use the [MyClockCustomizer], pass your clock into it, using a ClockBuilder.
///
/// ```
///   final myClockBuilder = (ClockModel model) => AnalogClock(model);
...
/// ```
/// Contestants: Do not edit this.
class MyClockCustomizer extends StatefulWidget {
  const MyClockCustomizer(this._clock, {this.lightTheme, this.darkTheme});
  ...
  @override
  _MyClockCustomizerState createState() => _MyClockCustomizerState();
}

class _MyClockCustomizerState extends State<MyClockCustomizer> {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: <Widget>[
                ...
                _enumMenu('Theme', _model.themeMode,
                ...
                _switch('Is Charging', _model.isCharging, (bool value) {
                  setState(() {
                    _model.isCharging = value;
                  });
                }),
                _textField(_model.chargeTime.toString(), 'Charge Time',
                    (String chargeTime) {
                  setState(() {
                    _model.chargeTime = chargeTime;
                  });
                }),
                _switch('Hide Second Background', _model.hideSecondBackground,
                    (bool value) {
                  setState(() {
                    _model.hideSecondBackground = value;
                  });
                }),
                _switch('Hide Second Tick', _model.hideSecondTick,
                    (bool value) {
                  setState(() {
                    _model.hideSecondTick = value;
                  });
                }),
                _enumMenu(
